...
export default function ContactPage() {
  return (
    <>
      <section className="relative overflow-hidden border-b border-ink/10 py-20 sm:py-28">
        ...
        <div className="container">
          <div className="relative max-w-3xl">
            ...
            <h1 className="mt-4 max-w-3xl font-heading text-5xl font-bold tracking-tight sm:text-6xl">Let&apos;s talk about growing your business.</h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-muted">Tell me a little about your business and what you&apos;re trying to achieve. I&apos;ll review your message and get back to you personally.</p>
            <div className="mt-7 flex flex-wrap gap-x-6 gap-y-3 text-sm font-semibold text-ink/65">
        ...
        <div className="container">
          <Reveal className="premium-card overflow-hidden rounded-[24px]">
            <div className="grid lg:grid-cols-[0.82fr_1.18fr]">
              <div className="ai-grid bg-ink p-7 text-white sm:p-10 lg:p-12">
              ...
              <div className="bg-white/70 p-5 sm:p-8 lg:p-12">
                <div className="mb-7">
                ...
                <div className="rounded-[18px] border border-ink/10 bg-cream/55 p-3 shadow-sm sm:p-5"><FlodeskForm /></div>
              </div>
            </div>
          </Reveal>
