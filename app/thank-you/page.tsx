    ...
    <section className="section border-b border-ink/10">
      <div className="container">
        <div className="mx-auto max-w-4xl">
          <div className="relative overflow-hidden rounded-[24px] bg-ink p-7 text-white shadow-soft sm:p-12">
            ...
            <div className="relative grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
              <div className="text-center lg:text-left">
                <div className="mx-auto grid size-16 place-items-center rounded-full bg-gold text-ink lg:mx-0"><Check size={32} strokeWidth={3} /></div>
                ...
                <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/70 lg:mx-0">Thanks for reaching out. I&apos;ve received your information and will review it shortly.</p>
                <div className="mt-9 flex flex-wrap justify-center gap-3 lg:justify-start"><Link href="/contact" className="inline-flex items-center gap-2 rounded-full bg-gold px-6 py-3 font-semibold text-ink transition hover:bg-white">Return to booking form <ArrowRight size={18} /></Link><Link href="/" className="inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-3 font-semibold text-white transition hover:border-gold hover:text-gold">Back to home</Link><a href={whatsappLink} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-3 font-semibold text-white transition hover:border-gold hover:text-gold">Chat on WhatsApp <MessageCircle size={18} /></a></div>
              </div>
              <div className="overflow-hidden rounded-[20px] bg-black/30 shadow-soft">
                ...
                <div className="border-t border-white/10 p-5 sm:p-6">
                  ...
                  <h2 className="mt-3 font-heading text-2xl font-bold">Have a quick question?</h2>
                  <p className="mt-3 leading-7 text-white/70">You can also reach me directly using WhatsApp, email, or phone.</p>
                  <div className="mt-5 flex flex-wrap gap-3">
                    <a href={whatsappLink} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#1f7a4d] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#17633d]"><MessageCircle size={17} /> Chat with me</a>
                    <a href={`mailto:${brand.email}`} className="inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-2.5 text-sm font-semibold text-white transition hover:border-gold hover:text-gold"><Mail size={17} /> Email me</a>
                  </div>
                </div>
              </div>
            </div>
